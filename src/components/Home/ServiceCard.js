...
const ServiceCard = () => {
  return (
    <article className="bg-charcoal px-5 md:px-3 min-h-[320] md:min-h-[300] lg:min-h-[350] rounded-[20] shadow-lg flex flex-col items-center justify-center">
      <FaWordpress className="text-[85px] md:text-[60px] lg:text-[75]" />
